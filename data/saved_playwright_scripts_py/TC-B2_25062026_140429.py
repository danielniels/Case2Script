# Auto-generated Playwright script — TC-B2_25062026_140429
# Generated: 2026-06-25 14:08:58
# Source: TC-B2_25062026_140429.json
# Run: python TC-B2_25062026_140429.py
...
SCREENSHOT_DIR = 'data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429'
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            try:
                ...
                pass
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_1.png')

            # Step 2: Mengisi Username → daniel.purba@is-gs.com
            print('>> STEP 2')
            await page.locator('xpath=//input[@id="email"]').first.fill('daniel.purba@is-gs.com')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_2.png')

            # Step 3: Mengisi Password → Password
            print('>> STEP 3')
            await page.locator('xpath=//input[@id="password"]').first.fill('Password')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_3.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_4.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_5.png')

            # Step 6: Tutup Pop Up Message
            print('>> STEP 6')
            await page.keyboard.press('Escape')
            await page.wait_for_timeout(1000)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_6.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_8.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_9.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_10.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_11.png')

            # Step 12: Mengisi Start Date → 30-Jul-2026
            print('>> STEP 12')
            await page.locator('//input[@id="request_start"]').first.fill('30-Jul-2026')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_12.png')

            # Step 13: Mengisi End Date → 30-Jul-2026
            print('>> STEP 13')
            await page.locator('//input[@id="request_end"]').first.fill('30-Jul-2026')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_13.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_14.png')

            # Step 15: Upload Supporting File → dummy.png
            print('>> STEP 15')
            await page.set_input_files('xpath=//input[@id="request_file"]', ['dummy.png'])
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_15.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_16.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_18.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-B2_25062026_140429/step_19.png')
