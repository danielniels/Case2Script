# Auto-generated Playwright script — TC-002_23062026_162554
# Generated: 2026-06-23 16:30:46
# Source: TC-002_23062026_162554.json
# Run: python TC-002_23062026_162554.py
...
SCREENSHOT_DIR = 'data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554'
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            try:
                ...
                pass
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_1.png')

            # Step 2: Type 'testerl1' in the username input box
            print('>> STEP 2')
            await page.locator('//input[@id="user_name"]').first.fill('testerl1')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_2.png')

            # Step 3: Type 'P@ssw0rd' in the password input box
            print('>> STEP 3')
            await page.locator('//input[@id="user_password"]').first.fill('P@ssw0rd')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_3.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_4.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_5.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_6.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_7.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_8.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_9.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_10.png')

            # Step 11: Click tab: Steps
            print('>> STEP 11')
            try:
                await page.evaluate("""(sel) => {
              function isVisible(node) {
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_11.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_12.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_13.png')

            # Step 14: Click + button to add a new step row
            print('>> STEP 14')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_15.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_16.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_17.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-002_23062026_162554/step_19.png')
