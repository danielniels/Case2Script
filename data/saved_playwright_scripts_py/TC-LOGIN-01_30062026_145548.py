# Auto-generated Playwright script — TC-LOGIN-01_30062026_145548
# Generated: 2026-06-30 15:02:39
# Source: TC-LOGIN-01_30062026_145548.json
# Run: python TC-LOGIN-01_30062026_145548.py
...
SCREENSHOT_DIR = 'data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548'
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            try:
                ...
                pass
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548/step_1.png')

            # Step 2: Fill username field with qatester@mail.com
            print('>> STEP 2')
            await page.locator('//input[@id="email"]').first.fill('qatester@mail.com')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548/step_2.png')

            # Step 3: Fill password field with password123
            print('>> STEP 3')
            await page.locator('//input[@id="password"]').first.fill('password123')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548/step_3.png')
            ...
            # STEP 4 FAILED [click_by_index] — fix manually before running
            # Click the Login button
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548/step_4.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/TC-LOGIN-01_30062026_145548/step_5.png')
