# Auto-generated Playwright script — 5969b52f_TC001_02072026_172200
# Generated: 2026-07-02 17:24:58
# Source: 5969b52f_TC001_02072026_172200.json
# Run: python 5969b52f_TC001_02072026_172200.py
...
SCREENSHOT_DIR = 'data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200'
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            try:
                ...
                pass
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_1.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_2.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_3.png')

            # Step 4: Mengisi Username → qatester837291
            print('>> STEP 4')
            await page.locator('xpath=//input[@name="usernameRegisterPage"]').first.fill('qatester837291')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_4.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_5.png')

            # Step 6: Mengisi Password → TestPass123!
            print('>> STEP 6')
            await page.locator('xpath=//input[@name="passwordRegisterPage"]').first.fill('TestPass123!')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_6.png')

            # Step 7: Isi Confirm Password → TestPass123!
            print('>> STEP 7')
            await page.locator('//input[@name="confirm_passwordRegisterPage"]').first.fill('TestPass123!')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_7.png')

            # Step 8: Isi First Name → Budi
            print('>> STEP 8')
            await page.locator('//input[@name="first_nameRegisterPage"]').first.fill('Budi')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_8.png')

            # Step 9: Isi Last Name → Santoso
            print('>> STEP 9')
            await page.locator('//input[@name="last_nameRegisterPage"]').first.fill('Santoso')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_9.png')

            # Step 10: Isi Phone Number → 081234567890
            print('>> STEP 10')
            await page.locator('//input[@name="phone_numberRegisterPage"]').first.fill('081234567890')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_10.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_11.png')

            # Step 12: Isi City → Jakarta
            print('>> STEP 12')
            await page.locator('//input[@name="cityRegisterPage"]').first.fill('Jakarta')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_12.png')

            # Step 13: Isi Address → Jl. Sudirman No. 45
            print('>> STEP 13')
            await page.locator('//input[@name="addressRegisterPage"]').first.fill('Jl. Sudirman No. 45')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_13.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_14.png')

            # Step 15: Isi Postal Code → 12190
            print('>> STEP 15')
            await page.locator('//input[@name="postal_codeRegisterPage"]').first.fill('12190')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_15.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_16.png')
            ...
            try:
                ...
                pass
            await page.wait_for_timeout(800)
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/5969b52f_TC001_02072026_172200/step_17.png')
