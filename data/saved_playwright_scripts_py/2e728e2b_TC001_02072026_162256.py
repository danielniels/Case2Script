# Auto-generated Playwright script — 2e728e2b_TC001_02072026_162256
# Generated: 2026-07-02 16:23:23
# Source: 2e728e2b_TC001_02072026_162256.json
# Run: python 2e728e2b_TC001_02072026_162256.py
...
SCREENSHOT_DIR = 'data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256'
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            try:
                ...
                pass
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256/step_1.png')

            # Step 2: Mengisi Username → tomsmith
            print('>> STEP 2')
            await page.locator('xpath=//input[@id="username"]').first.fill('tomsmith')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256/step_2.png')

            # Step 3: Mengisi Password → SuperSecretPassword!
            print('>> STEP 3')
            await page.locator('xpath=//input[@id="password"]').first.fill('SuperSecretPassword!')
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256/step_3.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256/step_5.png')
            ...
            await page.screenshot(path='data/saved_playwright_scripts_py/screenshots/2e728e2b_TC001_02072026_162256/step_6.png')
