// Auto-generated Playwright script — TC-001_17062026_104616
// Generated: 2026-06-17 10:46:24
// Source: TC-001_17062026_104616.json
// Run: node TC-001_17062026_104616.js
// Requires: npm install playwright && npx playwright install chromium

const { chromium } = require('playwright');
const { mkdirSync } = require('fs');

mkdirSync('saved_playwright_scripts/screenshots/TC-001_17062026_104616', { recursive: true });
...
async function runTest() {
  ...
  try {
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_104616/step_1.png" });
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_104616/step_2.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_104616/step_3.png" });
