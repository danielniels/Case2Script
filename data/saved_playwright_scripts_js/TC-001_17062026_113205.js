// Auto-generated Playwright script — TC-001_17062026_113205
// Generated: 2026-06-17 11:33:32
// Source: TC-001_17062026_113205.json
// Run: node TC-001_17062026_113205.js
// Requires: npm install playwright && npx playwright install chromium

const { chromium } = require('playwright');
const { mkdirSync } = require('fs');

mkdirSync('saved_playwright_scripts/screenshots/TC-001_17062026_113205', { recursive: true });
...
async function runTest() {
  ...
  try {
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_1.png" });
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_2.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_3.png" });

    // Step 4: Pilih Jenis Matra Posisi: Darat
    console.log('▶ STEP 4');
    await page.selectOption("//select[@id=\"lo-matra\"]", { label: "Darat" });
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_4.png" });

    // Step 5: Fill Luas Lahan Digunakan: 15000
    console.log('▶ STEP 5');
    await page.locator("#lo-luas").first().fill("15000");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_5.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_6.png" });

    // Step 7: Mengisi Nama Lokasi -> Gudang Bekasi
    console.log('▶ STEP 7');
    await page.locator("#lo-nama").first().fill("Gudang Bekasi");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_7.png" });
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_8.png" });

    // Step 9: Mengisi Kabupaten/Kota -> Bekasi
    console.log('▶ STEP 9');
    await page.locator("#lo-kota").first().fill("Bekasi");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_9.png" });

    // Step 10: Mengisi Kecamatan -> Cibitung
    console.log('▶ STEP 10');
    await page.locator("#lo-kec").first().fill("Cibitung");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_10.png" });

    // Step 11: Mengisi Kelurahan -> Cibitung
    console.log('▶ STEP 11');
    await page.locator("#lo-kel").first().fill("Cibitung");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_11.png" });

    // Step 12: Mengisi Kode Pos -> 17520
    console.log('▶ STEP 12');
    await page.locator("#lo-pos").first().fill("17520");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_12.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_13.png" });
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_14.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_15.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_16.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_17.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_113205/step_18.png" });
