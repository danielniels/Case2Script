// Auto-generated Playwright script — TC-001_17062026_111522
// Generated: 2026-06-17 11:15:41
// Source: TC-001_17062026_111522.json
// Run: node TC-001_17062026_111522.js
// Requires: npm install playwright && npx playwright install chromium

const { chromium } = require('playwright');
const { mkdirSync } = require('fs');

mkdirSync('saved_playwright_scripts/screenshots/TC-001_17062026_111522', { recursive: true });
...
async function runTest() {
  ...
  try {
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_1.png" });
    ...
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_2.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_3.png" });

    // Step 4: Pilih Jenis Matra Posisi: Darat
    console.log('▶ STEP 4');
    await page.selectOption("//select[@id=\"lo-matra\"]", { label: "Darat" });
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_4.png" });

    // Step 5: Fill Luas Lahan Digunakan: 15000
    console.log('▶ STEP 5');
    await page.locator("#lo-luas").first().fill("15000");
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_5.png" });
    ...
    await page.waitForLoadState('networkidle').catch(() => {});
    await page.waitForTimeout(800);
    await page.screenshot({ path: "saved_playwright_scripts/screenshots/TC-001_17062026_111522/step_6.png" });
